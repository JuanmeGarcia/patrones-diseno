...
class ElectricCar implements Vehicle {
  ...
  assemble(): void {
    console.log('Ensamblando vehiculo %celectrico', COLORS.blue);
  }
}
...
class GasCar implements Vehicle {
  ...
  assemble(): void {
    console.log('Ensamblando vehiculo %cde combustion', COLORS.gray);
  }
}
...
class ElectricEngine implements Engine {
  ...
  start(): void {
    console.log('Arrancando motor %celectrico', COLORS.blue);
  }
...
class GasEngine implements Engine {
  ...
  start(): void {
    console.log('Arrancando motor %ca gas', COLORS.gray);
  }
}
